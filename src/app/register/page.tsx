...
import { Music, ArrowRight, Loader2, AlertCircle, ShieldCheck } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#020202] flex items-center justify-center px-6 py-12">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-semibold font-outfit text-white mb-2 tracking-tight">Crie sua conta</h1>
          <p className="text-zinc-500 font-medium">Junte-se à maior plataforma para músicos de louvor</p>
        </div>
        ...
        <div className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-zinc-400 uppercase tracking-widest ml-1">Nome Completo</label>
              <input 
                type="text" 
                required
            ...
            <div className="space-y-2">
              <label className="text-[13px] font-semibold text-zinc-400 uppercase tracking-widest ml-1">Senha</label>
              <input 
                type="password" 
                required
                className="w-full bg-zinc-900/50 border border-white/5 rounded-xl px-4 py-3 text-white outline-none focus:border-yellow-500/50 focus:ring-1 focus:ring-yellow-500/20 transition-all placeholder:text-zinc-700"
            ...
            <div className="flex items-start gap-3 p-4 bg-white/5 rounded-xl border border-white/5">
                ...
                <p className="text-[11px] text-zinc-400 leading-relaxed font-medium">Ao se registrar, você concorda com nossos termos de privacidade e garante acesso vitalício às cifras limpas.</p>
            </div>
